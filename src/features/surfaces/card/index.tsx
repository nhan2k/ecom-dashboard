...
import liveFromSpaceImage from './assets/live-from-space.jpg'
...
export default function MediaControlCard() {
  ...
  return (
    <Card sx={{ display: 'flex' }}>
      ...
      <CardMedia component="img" sx={{ width: 151 }} image={liveFromSpaceImage} alt="Live from space album cover" />
    </Card>
  )
}
