...
import { getProductTagState, putProductTagAsyncThunk, setProductId, setTagId } from '@/features/redux/slices/product-tag';
...
const UpdateForm: React.FC<IUpdateForm> = ({ id, handleCloseModalUpdate }) => {
  ...
  const { dataInput, putLoading, putError } = useAppSelector(getProductTagState);
  const dispatch = useAppDispatch();

  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    await dispatch(putProductTagAsyncThunk({ data, id }));
