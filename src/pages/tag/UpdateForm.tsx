...
import { getTagState, putTagAsyncThunk, setTitle } from '@/features/redux/slices/tag';
...
const UpdateForm: React.FC<IUpdateForm> = ({ id, handleCloseModalUpdate }) => {
  ...
  const { dataInput, putLoading, putError } = useAppSelector(getTagState);
  const dispatch = useAppDispatch();

  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    await dispatch(putTagAsyncThunk({ data, id }));
