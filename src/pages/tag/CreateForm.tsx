...
import { createTagAsyncThunk, getTagState, setTitle } from '@/features/redux/slices/tag';
...
const CreateForm: React.FC<ICreateForm> = ({ handleCloseModalCreate }) => {
  ...
  const { dataInput, postLoading, postError } = useAppSelector(getTagState);
  const dispatch = useAppDispatch();

  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    await dispatch(createTagAsyncThunk(data));
