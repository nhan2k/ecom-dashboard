...
import { getAllTagAsyncThunk, getTagState } from '@/features/redux/slices/tag';
...
const Tag: React.FunctionComponent<ITag> = () => {
  const dispatch = useAppDispatch();
  const { dataGetAll, getAllLoading } = useAppSelector(getTagState);

  React.useEffect(() => {
    let flag = true;
    if (flag) {
      dispatch(getAllTagAsyncThunk());
    }
