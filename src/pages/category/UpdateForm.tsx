...
import { getCategoryState, putCategoryAsyncThunk, setTitle } from '@/features/redux/slices/category';
...
const UpdateForm: React.FC<IUpdateForm> = ({ id, handleCloseModalUpdate }) => {
  ...
  const { dataInput, putLoading, putError } = useAppSelector(getCategoryState);
