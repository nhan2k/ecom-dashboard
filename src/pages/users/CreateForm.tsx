...
import { createUserAsyncThunk, getUserState, setEmail, setPassword } from '@/features/redux/slices/user';
...
const CreateForm: React.FC<ICreateForm> = ({ handleCloseModalCreate }) => {
  ...
  const { dataInput, postLoading, postError } = useAppSelector(getUserState);
  const dispatch = useAppDispatch();

  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    await dispatch(createUserAsyncThunk(data));
