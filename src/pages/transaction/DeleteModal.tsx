...
import { deleteTransactionAsyncThunk, getTransactionState } from '@/features/redux/slices/transaction';
...
const DeleteModal: React.FC<IDeleteModal> = ({ id }) => {
  ...
  const { deleteLoading, deleteError } = useAppSelector(getTransactionState);
