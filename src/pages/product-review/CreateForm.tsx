...
import { createProductReviewAsyncThunk, getProductReviewState, setProductId } from '@/features/redux/slices/product-review';
...
const CreateForm: React.FC<ICreateForm> = ({ handleCloseModalCreate }) => {
  ...
  const { dataInput, postLoading, postError } = useAppSelector(getProductReviewState);
  const dispatch = useAppDispatch();

  const onSubmit: SubmitHandler<Inputs> = async (data) => {
    await dispatch(createProductReviewAsyncThunk(data));
