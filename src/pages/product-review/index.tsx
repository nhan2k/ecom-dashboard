...
import { getAllProductReviewAsyncThunk, getProductReviewState } from '@/features/redux/slices/product-review';
...
const ProductReview: React.FunctionComponent<IProductReview> = () => {
  const dispatch = useAppDispatch();
  const { dataGetAll, getAllLoading } = useAppSelector(getProductReviewState);

  React.useEffect(() => {
    let flag = true;
    if (flag) {
      dispatch(getAllProductReviewAsyncThunk());
    }
